        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mb-6">
                ...
                <div className="relative">
                    <button
                        type="button"
                        onClick={() => setShowInitiatorFilter(!showInitiatorFilter)}
                        className={cn(
                ...
                <div className="max-w-sm mx-auto">
                    <div className="w-40 h-40 mx-auto mb-6">
                        <svg viewBox="0 0 200 200" className="w-full h-full">
                            ...
                            <rect x="55" y="60" width="40" height="50" rx="3" fill="#E5E7EB" />
                            <rect x="60" y="65" width="30" height="3" fill="#9CA3AF" />
                            <rect x="60" y="72" width="25" height="3" fill="#9CA3AF" />
                            <rect x="60" y="79" width="28" height="3" fill="#9CA3AF" />
                            {/* Person */}
                            <circle cx="120" cy="70" r="18" fill="#10B981" opacity="0.2" />
                            <circle cx="120" cy="65" r="12" fill="#374151" />
                            <rect x="108" y="85" width="24" height="35" rx="4" fill="#10B981" />
                            <rect x="105" y="120" width="12" height="30" fill="#374151" />
                            <rect x="123" y="120" width="12" height="30" fill="#374151" />
                            {/* Clipboard/document in hand */}
                            <rect x="135" y="90" width="25" height="32" rx="2" fill="#E5E7EB" />
                            <rect x="139" y="95" width="17" height="2" fill="#9CA3AF" />
                            <rect x="139" y="100" width="15" height="2" fill="#9CA3AF" />
                            <rect x="139" y="105" width="16" height="2" fill="#9CA3AF" />
                            <circle cx="147" cy="115" r="4" fill="#10B981" />
                        </svg>
                    </div>
                    <h2 className="text-xl font-semibold text-gray-900 mb-2">No expenses yet</h2>
                    <p className="text-gray-500 text-sm">
                        Expenses will appear once employees start making payments.
                    </p>
                </div>
            </div>
            ...
            {/* Click outside to close initiator filter */}
            {showInitiatorFilter && (
                <div className="fixed inset-0 z-10" onClick={() => setShowInitiatorFilter(false)} />
            )}
        </div>
    );
}
