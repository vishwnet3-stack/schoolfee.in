...
import { FaRupeeSign, FaSchool } from "react-icons/fa"

const navigation = [
  { name: "Overview", href: "/dashboard/school", icon: FiHome },
  { name: "Student Applications", href: "/dashboard/school/applications", icon: FiUsers },
  { name: "Fee Disbursements", href: "/dashboard/school/disbursements", icon: FaRupeeSign },
  { name: "Reports", href: "/dashboard/school/reports", icon: FiFileText },
  { name: "Settings", href: "/dashboard/school/settings", icon: FiSettings },
]
      ...
      <aside className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col bg-white border-r">
        <div className="flex flex-col flex-grow">
          ...
          <div className="px-4 py-4 border-b">
            <div className="flex items-center gap-3 px-2 py-2 rounded-lg bg-gray-100">
              <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center">
                <FaSchool className="text-blue-600" size={18} />
              </div>
          ...
          <div className="px-4 py-4 border-t">
            <Link
              href="/"
              className="flex items-center gap-3 w-full px-3 py-2.5 text-sm text-gray-600 hover:bg-gray-100 rounded-lg transition"
            >
              <FiLogOut size={18} />
              Back to Website
            </Link>
